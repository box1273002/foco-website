...
export const PricingBox = ({ title, year, month, lifetime, benefits }: { title: string, year: number, month: number, lifetime: number, benefits: string[] }) => {
  ...
  return (
    <div className={`border min-h-full border-gray-800 hover:border-purple-600 m-4  flex flex-col p-8 rounded-3xl bg-gradient-to-br from-gray-900 to-black transition-all duration-300 ${glowColor}`}>
