    ...
    <div className="relative">
      <Container>
            ...
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              {navigation.map((item, index) => (
                <Link
                  ...
                  className="w-full px-4 py-2  rounded-md text-gray-300 hover:text-indigo-500 focus:text-indigo-500  focus:outline-none focus:bg-trueGray-700"
                >
                  {item}
                </Link>
              ))}
        ...
        <div className="my-10 text-sm text-center text-gray-400">
          Copyright © {new Date().getFullYear()}. Made with ♥  by FOCO: The Focus Corporation.
        </div>
      </Container >
    </div >
  );
