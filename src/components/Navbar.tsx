...
const getMenuStyle = (isSelected) => {
  ...
  return "text-purple-600 dark:text-purple-400 drop-shadow-[0_0_30px_rgba(37,99,235,1)] dark:drop-shadow-[0_0_30px_rgba(153,209,250,1)]"
};
                  ...
                  {navigation.map((item, index) => (
                    <Link
                      ...
                      className={`w-full px-4 py-2 -ml-4 rounded-md ${selected === item
                        ? ` text-purple-600 dark:text-purple-400 underline underline-offset-4 filter drop-shadow-[0_0_30px_rgba(37,99,235,1)] dark:drop-shadow-[0_0_30px_rgba(153,209,250,1)]`
